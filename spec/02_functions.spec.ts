...
describe('a couple of examples', () => {
    it('working with something other than integers', () => {
        ...
        const data: Vehicle[] = [
            ...
            { vin: '7038939', make: 'Honda', model: 'Pilot', year: 2019, mileage: 1_323 },
            { vin: '8399393', make: 'Chevy', model: 'Bolt', year: 2018, mileage: 223_338 },
        ];

        // Your CODE HERE
        // Using on statement, find all the vehicles that have more than 100_000 miles and give me the make and model as below.
